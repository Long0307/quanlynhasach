...
$mail->SMTPAuth=true;
$mail->SMTPSecure='tls';
$mail->Username='phunglongtn@gmail.com';//Your Email Address
$mail->Password='L0375769686@';//Your Email Password
$mail->setFrom('phunglongtn@gmail.com','Notification');
$mail->addAddress('phunglongo1234@gmail.com');//Receiver Email
$mail->addReplyTo('phunglongtn@gmail.com');
$mail->isHTML(true);
